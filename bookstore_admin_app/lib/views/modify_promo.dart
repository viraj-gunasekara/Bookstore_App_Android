...
class _ModifyPromoState extends State<ModifyPromo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(bookId.isNotEmpty? _isPromo? "Update Promotions":"Update Banners" : _isPromo? "Add Promotion":"Add Banner" ),
      ),
            ...
            child: Column(
              children: [
                ...
                if(bookId.isNotEmpty){
                  DbService().updatePromos(id: bookId, data: data,isPromo: _isPromo);
                  Navigator.pop(context);
                  ...
                  }, child: Text(bookId.isNotEmpty? _isPromo? "Update Promo":"Update Banner" : _isPromo? "Add Promo":"Add Banner" )))
